...
class TestFragmentTemplatesRender:
    ...
    def test_success_alert(self):
        html = self._render("crudkit/fragments/common/success_alert.html", {"message": "Saved!"})
        assert "Saved!" in html
        assert "bg-green-200" in html

    def test_error_alert(self):
        html = self._render("crudkit/fragments/common/error_alert.html", {"message": "Failed!"})
        assert "Failed!" in html
        assert "bg-red-200" in html

    def test_page_heading(self):
        html = self._render("crudkit/fragments/common/page_heading.html", {"heading": "Widgets"})
        assert "Widgets" in html

    def test_page_heading_with_sub(self):
        html = self._render(
            "crudkit/fragments/common/page_heading.html",
    ...
    def test_page_heading_empty(self):
        html = self._render("crudkit/fragments/common/page_heading.html", {})
        assert html.strip() == ""

    def test_table_heading(self):
        html = self._render(
            "crudkit/fragments/table/table_heading.html",
    ...
    def test_table_cell(self):
        html = self._render(
            "crudkit/fragments/table/table_cell.html",
    ...
    def test_delete_action_can_delete(self):
        html = self._render(
            "crudkit/fragments/details/delete_action.html",
    ...
    def test_form_field_error(self):
        html = self._render(
            "crudkit/fragments/forms/form_field_error.html",
    ...
    def test_form_field_error_empty(self):
        html = self._render("crudkit/fragments/forms/form_field_error.html", {})
        assert html.strip() == ""

    def test_read_only_field(self):
        html = self._render(
            "crudkit/fragments/forms/read_only_field.html",
    ...
    def test_read_only_form_field(self):
        html = self._render(
            "crudkit/fragments/forms/read_only_form_field.html",
            {"label": "Name", "value": "Widget A"},
        )
        assert "Name" in html
    ...
    def test_read_only_checkbox_checked(self):
        html = self._render(
            "crudkit/fragments/forms/read_only_checkbox.html",
    ...
    def test_loading_spinner(self):
        html = self._render("crudkit/fragments/loaders/loading_spinner.html")
        assert "htmx-indicator" in html
        assert "animate-spin" in html

    def test_busy_indicator(self):
        html = self._render("crudkit/fragments/loaders/busy_indicator.html")
        assert "Busy.." in html

    def test_busy_indicator_custom_message(self):
        html = self._render("crudkit/fragments/loaders/busy_indicator.html", {"message": "Loading..."})
    ...
    def test_submit_cancel(self):
        ...
        html = self._render("crudkit/fragments/forms/submit_cancel.html", {"form": FakeForm()})
        assert "/widgets/" in html
        assert "Save" in html

    def test_hx_add_model_oob_link(self):
        html = self._render(
            "crudkit/fragments/table/hx_add_model_oob_link.html",
